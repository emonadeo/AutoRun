...
public class AutoRunModMenu implements ModMenuApi, ConfigScreenFactory<Screen> {
	...
	public Screen create(Screen screen) {
		...
		ConfigCategory general = builder
				.getOrCreateCategory(Text.translatable("config." + AutoRunMod.MODID + ".general"));

		// Toogle Auto-Jump
		general.addEntry(entryBuilder
				.startBooleanToggle(Text.translatable("config." + AutoRunMod.MODID + ".toggleAutoJump"),
						AutoRunMod.isToggleAutoJump())
				.setDefaultValue(true)
				.setTooltip(Text.translatable("config." + AutoRunMod.MODID + ".toggleAutoJump.description"))
				.setSaveConsumer(AutoRunMod::setToggleAutoJump).build());

		// Delay Buffer
		general.addEntry(entryBuilder
				.startIntField(Text.translatable("config." + AutoRunMod.MODID + ".delayBuffer"),
						AutoRunMod.getDelayBuffer())
				.setDefaultValue(20)
				.setTooltip(Text.translatable("config." + AutoRunMod.MODID + ".delayBuffer.description"))
				.setSaveConsumer(AutoRunMod::setDelayBuffer).build());
